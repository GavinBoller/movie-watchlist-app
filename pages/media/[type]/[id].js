// pages/media/[type]/[id].js
   ...
   export default function MediaDetail() {
     ...
     if (!media && !error) return <div className="min-h-screen bg-dark text-white p-4">Loading...</div>;
             ...
             <div className="flex flex-col md:flex-row items-center">
               ...
               <div className="md:w-2/3">
                 ...
                 <button
                   ...
                   className="bg-success text-white py-2 px-4 rounded hover:bg-green-600"
                 >
                   Add to Watchlist
                 </button>
               </div>
