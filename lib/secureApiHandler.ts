...
interface SecureApiHandlerOptions {
 ...
 * @returns A wrapped handler with security enhancements
 */
export function secureApiHandler(handler: ApiHandler, options: SecureApiHandlerOptions = {}): ApiHandler {
  const { 
    allowedMethods = ['GET'], 
